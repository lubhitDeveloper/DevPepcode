...
(async function() {
    try{
        ...
        await page.type("#input-1", "yoxoya3171@yamails.net");
        ...
        let manageChallengeUrl= await page.url();
        ...
        {
            await page.goto(manageChallengeUrl);
            await Promise.all([page.waitForNavigation({waitUntil: "networkidle0"}), page.click(".btn.btn-green.backbone.pull-right")]);
 ...
 async function createChallenge(challenge){
     try{
        ...
        await tab.type("#problem_statement-container .CodeMirror.cm-s-default.CodeMirror-wrap textarea", problem);
        await tab.type("#input_format-container .CodeMirror.cm-s-default.CodeMirror-wrap textarea", input);
        await tab.type("#constraints-container .CodeMirror.cm-s-default.CodeMirror-wrap textarea", constraints);
        await tab.type("#output_format-container .CodeMirror.cm-s-default.CodeMirror-wrap textarea",output);
